...
_M.killer_filter = {
    init = function(env)
        ...
        load_configs(env.name_space, {
            ...
            {type = 'double', config_name = 'flypy_threshold', default = -10000},
            {type = 'double', config_name = 'flypy_offset', default = 20000},
            {type = 'double', config_name = 'flypy_sys_threshold', default = -10000},
            {type = 'double', config_name = 'flypy_sys_offset', default = 20000},
    ...
    func = function(input, env)
        ...
        for cand in input:iter() do
            -- cand:get_genuine().comment = cand.comment .. ' ' .. cand.type .. ' ' .. tostring(cand.quality) .. ' ' .. tostring(enable)
